...
export function useAuth() {
  const session = useState<Session | null>("auth:session", () => null) as Ref<Session | null>
  const cookies = useState<Record<string, string> | null>("auth:cookies", () => ({})) as Ref<Record<string, string> | null>
